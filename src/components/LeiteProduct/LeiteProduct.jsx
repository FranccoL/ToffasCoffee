...
import "./LeiteProduct.css";

export default function LeiteProduct() {
  const [activeTab, setActiveTab] = useState("descricao");
  const { addToCart } = useCart();
  const navigate = useNavigate();

  const preparoText = `
Coloque 2 colheres de sopa de Leite Toffa's Coffee.
Adicione 100mL de água quente.
Misture bem com uma colher ou mixer (recomendado).
Pronto! Agora é só aproveitar um leite cremoso e equilibrado.
  `;
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-content">
        ...
        <div className="product-info">
          ...
          <p className="product-desc">
            Leite solúvel, desenvolvido para oferecer sabor
            equilibrado, cremosidade e praticidade.
          </p>
      ...
      <div className="text-section">
        {activeTab === "descricao" && (
          <p>
            O Leite em pó do Toffa’s é uma bebida solúvel prática
